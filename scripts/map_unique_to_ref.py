...
BLAST_OUTPUT = os.path.join(dirname, '../data/unique_vs_ref_blastp.txt')
MAPPING_DIR = os.path.join(dirname, '../data/mappings/seq_to_ref/')
UNIQUE_SEQS = os.path.join(dirname, '../data/unique_sequences.fasta')
